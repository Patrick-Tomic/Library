...
const tds = document.querySelectorAll("tr[3]");
tds.forEach(td,toggleRead(td));
function toggleRead(td){
td.addEventListener('onclick',()=>{
    if(td.innerHTML =='<svg width="32" height="31" viewBox="0 0 32 31" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="21.1107" height="5.00231" transform="matrix(0.762286 0.64724 -0.449986 0.893036 3.5004 12.4375)" fill="#02FF2B"/> <rect width="28.3421" height="4.47" transform="matrix(0.475419 -0.879759 0.738497 0.674256 15.0821 25.7802)" fill="#02FF2B"/> </svg>'){
    td.innerHTML='<svg width="30" height="25" viewBox="0 0 30 25" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="31.898" height="5.70542" transform="matrix(0.722122 -0.691766 0.857633 0.514262 1.16681 22.0659)" fill="#FF0404"/> <rect width="32.6729" height="5.58018" transform="matrix(0.779204 0.62677 -0.813795 0.581152 4.54114 0.677856)" fill="#FF0404"/> </svg>';
  }else{
    console.log('bam');
    td.innerHTML ='<svg width="32" height="31" viewBox="0 0 32 31" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="21.1107" height="5.00231" transform="matrix(0.762286 0.64724 -0.449986 0.893036 3.5004 12.4375)" fill="#02FF2B"/> <rect width="28.3421" height="4.47" transform="matrix(0.475419 -0.879759 0.738497 0.674256 15.0821 25.7802)" fill="#02FF2B"/> </svg>';
  }
});
}